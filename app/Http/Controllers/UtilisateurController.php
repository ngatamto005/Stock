...
class UtilisateurController extends Controller
{
    ...
    public function traitement(Request $request){
        $request->validate(['utilisateur'=>'required','email'=>'email|required|unique:utilisateurs','contact'=>'required|size:9','password'=>'required|min:8']);
    ...
    public function connected(Request $request){
        ...
        if($utilisateur){
            ...
            return back()->with('status','veuillez verifier votre e-mail car incorrect ');
        }
    }

    public function deconnexion_link(){
        return view('authentification.deconnexion');
    }
